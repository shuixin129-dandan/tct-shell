					...
					<div id="cases">
						<div id="see_all">
							<xsl:for-each select="test_definition/suite">
								...
								<div id="suite_title">
									<h2>Test Suite:
									<xsl:value-of select="@name" /> (All)</h2>
									<a>
								...
								<table>
									...
									<xsl:for-each select=".//set">
										...
										<xsl:for-each select=".//testcase">
											...
											<tr>
												<td>
												    <div style="background-color:#F5DEB3;border:1px solid black;display:none;">
												    	<xsl:attribute name="id"><xsl:value-of select="@id" /></xsl:attribute>
												    	<p>
												    	<xsl:for-each select="./description/steps//step">
												    		<xsl:sort select="@order" />
												    	    <B>Step <xsl:value-of select="@order" />:</B><br/>
												    		<xsl:value-of select=".//step_desc" /><br/>
												    		<B>Expected:</B><xsl:value-of select=".//expected" /><br/>
												    	</xsl:for-each>
												    	</p>
												    	<p>
												    	<br/>
												    	<B>Entry:<br/></B>
												    	<xsl:value-of select="./description//test_script_entry" /><br/>
												    	</p>
												    </div>
						...
						<div id="see_fail"  style="display:none;">
							<xsl:for-each select="test_definition/suite">
								...
								<div id="suite_title">
									<h2>Test Suite:
									<xsl:value-of select="@name" /> (Failed only)</h2>
									<a>
										<xsl:attribute name="name">
                                                                     <xsl:value-of
											select="@name" />
									...
									<xsl:for-each select=".//set">
										...
										<xsl:for-each select=".//testcase[@result='FAIL']">
											...
											<tr>
												<td>
												   <div style="background-color:#F5DEB3;border:1px solid black;display:none;">
												    	<xsl:attribute name="id">fail_<xsl:value-of select="@id" /></xsl:attribute>
												    	<p>
												    	<xsl:for-each select="./description/steps//step">
												    		<xsl:sort select="@order" />
												    	    <B>Step <xsl:value-of select="@order" />:</B><br/>
						...
						<div id="see_block" style="display:none;">
							<xsl:for-each select="test_definition/suite">
								...
								<div id="suite_title">
									<h2>Test Suite:
									<xsl:value-of select="@name" /> (Blocked Only)</h2>
									<a>
										<xsl:attribute name="name">
                                                                     <xsl:value-of
											select="@name" />
									...
									<xsl:for-each select=".//set">
										...
										<xsl:for-each select=".//testcase[@result='BLOCK']">
											...
											<tr>
												<td>
													<div style="background-color:#F5DEB3;border:1px solid black;display:none;">
												    	<xsl:attribute name="id">block_<xsl:value-of select="@id" /></xsl:attribute>
												    	<p>
												    	<xsl:for-each select="./description/steps//step">
												    		<xsl:sort select="@order" />
												    	    <B>Step <xsl:value-of select="@order" />:</B><br/>
						...
						<div id="see_na" style="display:none;">
							<xsl:for-each select="test_definition/suite">
								...
								<div id="suite_title">
									<h2>Test Suite:
									<xsl:value-of select="@name" /> (Not executed Only)</h2>
									<a>
										<xsl:attribute name="name">
                                                                     <xsl:value-of
											select="@name" />
									...
									<xsl:for-each select=".//set">
										...
										<xsl:for-each select=".//testcase[@result='N/A']">
											...
											<tr>
												<td>
													 <div style="background-color:#F5DEB3;border:1px solid black;display:none;">
												    	<xsl:attribute name="id">na_<xsl:value-of select="@id" /></xsl:attribute>
												    	<p>
												    	<xsl:for-each select="./description/steps//step">
												    		<xsl:sort select="@order" />
												    	    <B>Step <xsl:value-of select="@order" />:</B><br/>
