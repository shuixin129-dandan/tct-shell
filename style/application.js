...
function drawSuiteRatio(node) {
	...
	fail_rate = Math.round(fail_rate)
	block_rate = Math.round(block_rate)
	na_rate = Math.round(na_rate)

	var pass_style = "padding:3px 0px 0px 0px;font-size:9pt;height:17px;text-align:center;color:white;font-weight:bold;background:url(&quot;blue.jpg&quot;);"
	var fail_style = "padding:3px 0px 0px 0px;font-size:9pt;height:17px;text-align:center;color:white;font-weight:bold;background:url(&quot;red.jpg&quot;);"
	var block_style = "padding:3px 0px 0px 0px;font-size:9pt;height:17px;text-align:center;color:white;font-weight:bold;background:url(&quot;orange.jpg&quot;);"
	var na_style = "padding:3px 0px 0px 0px;font-size:9pt;height:17px;text-align:center;color:white;font-weight:bold;background:url(&quot;gray.jpg&quot;);"
